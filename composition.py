...
# -*- coding: utf-8 -*-
"""
Created on Sun Aug 14 23:01:56 2022
...
# Composition is a type of Aggregation in which two entities are extremely
#  reliant on one another.
# 
# It indicates a relationship component.
# Both entities are dependent on each other in composition.
# The composed object cannot exist without the other entity when there is a
#  composition between two entities.
# 
# =============================================================================
